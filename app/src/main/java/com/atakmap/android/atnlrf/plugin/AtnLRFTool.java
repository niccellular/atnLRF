...
import com.atakmap.android.atnlrf.AtnLRFDropDownReceiver;
...
public class AtnLRFTool extends Tool implements ToolDescriptor {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                AtnLRFDropDownReceiver.SHOW_PLUGIN);
